...
import '../../delegate/presentation/pages/delegate_setup_page.dart';

class BeneficiarySettingsPage extends StatefulWidget {
  final String userRole;

  const BeneficiarySettingsPage({super.key, required this.userRole});

  @override
  State<BeneficiarySettingsPage> createState() => _SettingsPageState();
}

class _SettingsPageState extends State<BeneficiarySettingsPage> {
  @override
